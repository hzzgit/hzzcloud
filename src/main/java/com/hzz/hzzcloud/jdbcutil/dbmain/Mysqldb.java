package com.hzz.hzzcloud.jdbcutil.dbmain;
...
public class Mysqldb extends SqlExecuter implements MysqlDao {
    ...
    private void searchtablecolMap() {
        List<TableCol> query = query("select table_schema,table_name,column_name from information_schema.COLUMNS where table_schema not in ('information_schema','performance_schema','sys') ", TableCol.class);
