package com.hzz.hzzcloud.学习.事务的隔离级别.javaemail发送;
...
public class MailUtils {
    ...
    public static void main(String[] args) throws AddressException, MessagingException {
        ...
        // 设置收件人邮箱地址
        message.setRecipients(Message.RecipientType.TO, new InternetAddress[]{new InternetAddress("605198347@qq.com")});
