...
public class JavaRtkUtils {
    ...
    public  CoordinateVo xyTowgs84(double x, double y, double L0) {
        double a = 6378137.0D;
        ...
        return new CoordinateVo(Bdec, Ldec);
    }
    ...
    public CoordinateVo GetXY(double B, double L, double degree) {
        ...
        return new CoordinateVo((xy[0]), xy[1]);
    }

    public static void main(String[] args) {
        JavaRtkUtils javaRtkUtils = new JavaRtkUtils();
        CoordinateVo tuple1=javaRtkUtils.GetXY(37.203267527777776, 115.40381543333334, 3.0);
         double degreen1= javaRtkUtils.gaussLongToDegreen(37.203267527777776, 115.40381543333334, 3);
        CoordinateVo xyTowgs841 = javaRtkUtils.xyTowgs84(tuple1.getLat(), tuple1.getLng(), degreen1);
