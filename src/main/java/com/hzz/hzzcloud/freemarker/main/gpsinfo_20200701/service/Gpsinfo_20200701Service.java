    ...
    package com.hzz.hzzcloud.freemarker.main.gpsinfo_20200701.service;
    /**
    * 业务层
    */
    ...
    @Service
    @Slf4j
    public class Gpsinfo_20200701Service {
        ...
        */
        public PaginateResult selectlist(Map param, int page, int pagesize) {
            String queryId = "gpsinfo_20200701mapper.selectlist";
        ...
        * 保存
        */
        public void save(Gpsinfo_20200701 gpsinfo_20200701) throws Exception {
            if (gpsinfo_20200701.getGpsid() == 0) {//新增
            jdbcUtil.insert(gpsinfo_20200701).execute();
            } else {//修改
            jdbcUtil.update(gpsinfo_20200701).whereIdRefValueEQ().updateColumn(ColumnSet.all()).execute();
            }
        }
        ...
        */
        public void fdelete(String Id) throws Exception {
            ...
            String sql = "update gps_hisdata.gpsinfo_20200701 set deleted =id where gpsid=? ";
        ...
        */
        public void delete(String Id) throws Exception {
            String sql = "delete from  gps_hisdata.gpsinfo_20200701  where gpsid=? ";
            jdbcUtil.sql(sql).addIndexParam(Id).executeUpdate();
        }
