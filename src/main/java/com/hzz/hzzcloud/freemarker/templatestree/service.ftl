                ...
                */
                public Map depNodeTree(Integer id, List<Department> depList) {
                    ...
                    List<Long> depids = new ArrayList<>();
                        String sql = "select * from ${tableschema}.${tableVobyDep.tablename} where mainid = ?  and deleted = 0";
                        List<${tableVobyDep.entityName}> datas = jdbcUtil.sql(sql).addIndexParam(id).query(${tableVobyDep.entityName}.class);
                            ...
                            */
                            ...
                            String sql = "update ${tableschema}.${tableVobyVehicle.tablename} set deleted = 1 where mainid = ? and vehicleId = ?";
                            ...
                            List< ${tableVobyVehicle.entityName}> ${tableVobyVehicle.tablename}s = new ArrayList<>();
                                ...
                                ${tableVobyVehicle.entityName} ${tableVobyVehicle.tablename}=new ${tableVobyVehicle.entityName}();
                            ...
                            ${tableVobyVehicle.tablename}s.add(${tableVobyVehicle.tablename});
                                ...
                                for (${tableVobyVehicle.entityName} ${tableVobyVehicle.tablename} : ${tableVobyVehicle.tablename}s) {
                                try {
                            ...
                            */
                            ...
                            List<${tableVobyVehicle.entityName}> ${tableVobyVehicle.tablename}List = jdbcUtil.sql(sql).addIndexParam(id).query(${tableVobyVehicle.entityName}.class);
                                            ...
                                            List<Long> vehicleIdList = uservehicleauthority.getVehicleIdList();
                                                ...
                                                List<Long> vedepList = new ArrayList<>();
                                                    ...
                                                    List<Department> departmentList = getAuthorizedDepList(depList);
                                                        ...
                                                        for (${tableVobyVehicle.entityName} ${tableVobyVehicle.tablename} : ${tableVobyVehicle.tablename}List) {
                                                        Long depId = new Long(0);
                                                        if (realDataServiceRedis.getVehiclemap().get(ConverterUtils.toString(${tableVobyVehicle.tablename}.getVehicleid(), "")) != null) {
                                                        depId = realDataServiceRedis.getVehiclemap().get(ConverterUtils.toString(${tableVobyVehicle.tablename}.getVehicleid(), "")).getDepId();
                                                        }
                                                        if (depMap.containsKey(depId) || vehicleMap.containsKey(${tableVobyVehicle.tablename}.getVehicleid())) {
                                                        ...
                                                        Map<Long, List<HashMap>> vehiclesbydep = new HashMap<>();
                                                            ...
                                                            List<String> dellist = new ArrayList<>();
                                                                ...
                                                                String delsql = "delete from ${tableVobyUserLim.tablename} where mainid=? and userid = ?";
                                                                jdbcUtil.sql(delsql).addIndexParam(id, deleteuserid).executeUpdate();
                                                                }
                                                                }

                                                                if (adduserIdsArr != null && adduserIdsArr.length > 0) {
                                                                List<${tableVobyUserLim.entityName}> ${tableVobyUserLim.tablename}s = new ArrayList<>();
                                                                    for (String userid : adduserIdsArr) {
                                                                    ${tableVobyUserLim.entityName} ${tableVobyUserLim.tablename} = new ${tableVobyUserLim.entityName}();
                                                                    ${tableVobyUserLim.tablename}.setMainid(id);
                                                                    ${tableVobyUserLim.tablename}.setUserid(Long.parseLong(userid));
                                                                    ${tableVobyUserLim.tablename}s.add(${tableVobyUserLim.tablename});
                                                                    }
                                                                    LoopUtil.splitLoop(${tableVobyUserLim.tablename}s, 3000, list -> {
                                                                    try {
