package com.hzz.hzzcloud.读取类生成建表语句;
...
public class SqlGenerator {
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "D:\\mycode\\hzzcode\\hzzcloud\\src\\main\\java\\com\\hzz\\hzzcloud\\读取类生成建表语句\\model";
        //生成sql的文件夹
        String filePath = "D:\\tmp";
        //项目中实体类的路径
        String prefix = "com.hzz.hzzcloud.读取类生成建表语句.model.";
        String className = "";
