...
String name="{\n";
        ...
        name +="  \"operpermit\":\"测试\", //\n";
        name +="  \"platecolor\":1, //车辆颜色\n";
        name +="  \"plateno\":\"测试\", //车牌号\n";
        name +="  \"region\":\"测试\", //车籍地\n";
        name +="  \"routes\":\"测试\", //\n";
        name +="  \"runstatus\":\"测试\", //运行状态\n";
        name +="  \"simno\":\"测试\", //\n";
        name +="  \"status\":\"测试\", //\n";
        name +="  \"termid\":1, //\n";
        name +="  \"usetype\":\"测试\", //\n";
        name +="  \"vehicletype\":\"测试\", //车辆类型\n";
        name +="  \"vendor\":\"测试\", //\n";
        ...
        name +="  \"photo\":\"测试\", //\n";
        name +="  \"companyid\":1, //\n";
        name +="  \"videochannelnum\":1, //视频通道数\n";
        name +="  \"username\":\"测试\", //\n";
        name +="  \"videodatatype\":1, //\n";
        name +="  \"channelid\":1, //\n";
        name +="  \"videodisk\":\"测试\", //\n";
        name +="  \"videochannelnames\":\"测试\", //视频通道名称\n";
        name +="  \"flowrateno\":\"测试\", //物联网卡号\n";
        name +="  \"vehiclepassword\":\"测试\", //车辆登录密码\n";
