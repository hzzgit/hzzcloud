package cheweiERP.t_contract_park.mapper;
/**
* 车场合同业务层
*/
...
public interface TContractParkMapper extends Mapper<TContractPark, Long> {

List<ContractParkVO> list(ContractParkSearchDTO contractparksearchDTO);
