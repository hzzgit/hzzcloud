                            ...
                            <String
                                ...
                                <String> dellist = new ArrayList<>();
                                    ...
                                    */
                                    ...
                                    String sql = "update ${tableVobyDep.tablename} set deleted = 1 where mainid = ? and
                                    depid =
                                    ?";
                                    ...
                                    ${tableVobyDep.entityName} ${tableVobyDep.tablename} =
                                    new ${tableVobyDep.entityName} ();
                                    ...
                                    */
                                    public boolean saveByVehicle(String[] addvehicleIds, String[] deletevehicleIds, Long
                                    id) {
                                    boolean arg = true;
                                    try {
                                    if (deletevehicleIds != null && deletevehicleIds.length > 0) {//这边是删除车辆
                                    for (String deletevehicleId : deletevehicleIds) {
                                    String sql = "update ${tableschema}.${tableVobyVehicle.tablename} set deleted = 1
                                    where
                                    ...
                                    List< ${tableVobyVehicle.entityName}> ${tableVobyVehicle.tablename}s = new
                                    ArrayList<>();
                                    ...
                                    */
                                    ...
                                    String sql = "select * from ${tableVobyVehicle.tablename} where mainId=? and deleted
                                    = 0";
                                                                ...
                                                                <Long> vedepList = new ArrayList<>();
                                                                    ...
                                                                    <Long
                                                                        ...
                                                                        <Department> departmentList =
                                                                            ...
                                                                            .getVehicleid())) {
                                                                            vehicleIds.add(${tableVobyVehicle.tablename}
                                                                            .getVehicleid());
                                                                            }
                                                                            ...
                                                                            <HashMap>> vehiclesbydep = new HashMap<>();
                                                                                ...
                                                                                <String
                                                                                    ...
                                                                                    {
                                                                                    Long dep =
                                                                                    ConverterUtils.toLong(stringObjectMap.get("depId"),
                                                                                    0);
                                                                                    List vehicleList = new
                                                                                    ArrayList<>();
                                                                                    if (depMap.containsKey(dep)) {
                                                                                    if (vehiclesbydep.containsKey(dep))
                                                                                    {
                                                                                    vehicleList =
                                                                                    vehiclesbydep.get(dep);
                                                                                    }
                                                                                    long vehicleId =
                                                                                    ...
                                                                                    if
                                                                                    (vehicleMap.containsKey(vehicleId))
                                                                                    {//必须是存在
                                                                                    arg = true;
                                                                                    }
                                                                                    } else {
                                                                                    ...
                                                                                    Map
                                                                                    <String
                                                                                            , ConfigTreeNode> deptreemap
                                                                                        = new LinkedHashMap<>();
                                                                                        for (Department dep :
                                                                                        departmentList) {
                                                                                        String depNodeId = "dep" +
                                                                                        dep.getEntityId();
                                                                                        long parentId =
                                                                                        dep.getParentId();
                                                                                        String strParentNodeId = "dep" +
                                                                                        parentId;
                                                                                        if (parentId == 0) {
                                                                                        strParentNodeId = "1";
                                                                                        }
                                                                                        ConfigTreeNode depNode = new
                                                                                        ConfigTreeNode(depNodeId,
                                                                                        dep.getName(), strParentNodeId);
                                                                                        int checknum = 0;
                                                                                        if
                                                                                        (depcomap.get(dep.getEntityId())
                                                                                        != null) {
                                                                                        checknum =
                                                                                        depcomap.get(dep.getEntityId());
                                                                                        }
                                                                                        ...
                                                                                        <String> dellist = new
                                                                                            ...
                                                                                            <ConfigTreeNode> childnodes
                                                                                                ...
                                                                                                v.setTotalNum(totalnum[0]
                                                                                                + v.getTotalNum());
                                                                                                v.setCheckNum(onlinenum[0]
                                                                                                + v.getCheckNum());
                                                                                                });
                                                                                                ...
                                                                                                null) {
                                                                                                data.put("depId",
                                                                                                vehiclebydep.getDepId());
                                                                                                data.put("plateNo",
                                                                                                vehiclebydep.getPlateNo());
                                                                                                allvehicledata.put(vehicleId,
                                                                                                data);
                                                                                                }
                                                                                                }
                                                                                                dataall.put("vehicleIds",
                                                                                                allvehicledata);
                                                                                                dataall.put("vehiclesbydep",
                                                                                                vehiclesbydep);
                                                                                                return dataall;
                                                                                                }
                                                                                                ...
                                                                                                public void
                                                                                                saveConfigByUser(Long
                                                                                                id, String[]
                                                                                                deleteuserIdsArr,
                                                                                                String[] adduserIdsArr)
                                                                                                {
                                                                                                try {
                                                                                                if (deleteuserIdsArr !=
                                                                                                null &&
                                                                                                deleteuserIdsArr.length
                                                                                                > 0) {
                                                                                                for (String deleteuserid
                                                                                                : deleteuserIdsArr) {
                                                                                                String delsql = "delete
                                                                                                from ${tableVobyUserLim.tablename}
                                                                                                where mainid=? and
                                                                                                userid = ?";
                                                                                                ...
                                                                                                LoopUtil.splitLoop(${tableVobyUserLim.tablename}
                                                                                                s, 3000,
                                                                                                list -> {
                                                                                                try {
                                                                                                jdbcUtil.insertList(list).setNotPrint().executeBatch(false);
                                                                                                } catch (Exception e) {
                                                                                                log.debug("批量用户和配置表绑定错误",
                                                                                                e);
                                                                                                list.forEach(v -> {
                                                                                                ...
                                                                                                <ConfigTreeNode>
                                                                                                    ...
                                                                                                    */
                                                                                                    ...
                                                                                                    PaginateResult
                                                                                                    paginateResult =
                                                                                                    queryService.queryByPagination(queryId,
                                                                                                    param, page,
                                                                                                    pagesize);
                                                                                                    return
                                                                                                    paginateResult;
                                                                                                    ...
                                                                                                    */
                                                                                                    public void
                                                                                                    save(${entityName} ${tablename}
                                                                                                    ,Long
                                                                                                    userid) throws
                                                                                                    Exception {
                                                                                                    if (${tablename}
                                                                                                    .get${pricolname?lower_case?cap_first}
                                                                                                    () == 0) {//新增
                                                                                                    ${tablename}
                                                                                                    .setCreatedate(new
                                                                                                    Date());
